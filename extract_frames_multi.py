...
def video2frames(pathIn='',
    ...
    https://www.shuzhiduo.com/A/MAzAoM4q59/
    '''
...
##### 测试
    pathIn = 'Love is a Lunatic City.mp4'
    pathOut = './Love is a Lunatic City/'
    video2frames(pathIn, pathOut, extract_time_interval = 10)